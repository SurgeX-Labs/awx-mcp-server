...
[📖 Full Copilot Chat Guide](https://github.com/your-org/awx-mcp/blob/HEAD/COPILOT_CHAT_GUIDE.md)
...
**See [FEATURE_COVERAGE.md](https://github.com/your-org/awx-mcp/blob/HEAD/FEATURE_COVERAGE.md) for complete capability reference (16 tools, 100% AWX API coverage)**
...
See [BUILD.md](https://github.com/your-org/awx-mcp/blob/HEAD/BUILD.md) for detailed build instructions.
...
- [Getting Started Guide](https://github.com/your-org/awx-mcp/blob/HEAD/../docs/GETTING_STARTED.md)
- [Extension Installation](https://github.com/your-org/awx-mcp/blob/HEAD/../docs/EXTENSION_INSTALL_REBUILD.md)
- [Troubleshooting](https://github.com/your-org/awx-mcp/blob/HEAD/../docs/EXTENSION_TROUBLESHOOTING.md)
- [FAQ](https://github.com/your-org/awx-mcp/blob/HEAD/../docs/FAQ.md)
...
MIT License - see [LICENSE](https://github.com/your-org/awx-mcp/blob/HEAD/LICENSE) for details.
